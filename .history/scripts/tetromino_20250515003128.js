...
const TetraminoType = {
    ...
    L:{
        ...
        shapes: [
            ...
            [new Position(0, 1), new Position(1, 1), new Position(1, 1), new Position(2, 1)],
            [new Position(1, 0), new Position(2, 1), new Position(2, 2), new Position(3, 2)],
            [new Position(0, 0), new Position(1, 2), new Position(2, 2), new Position(3, 2)]
        ]
    }
}