...
export class Game {
    constructor(canvas, rows, cols, cellSize, space, canvasNext) {
        ...
        this.hold = new BoardHold(canvasHold, 8, 4, cellSize, space, this.tetrominosBag.getThreeNextTetrominos());
    }
    update(){
    ...
    placeTetromino(){
        ...
        if(this.boardTetris.gameOver()){
            ...
            this.currentTetromino = this.tetrominosBag.nextTetromino();
            this.next.listTretominos = this.tetrominosBag.getThreeNextTetrominos();
